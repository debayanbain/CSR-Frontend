...
const menu: Array<Menu | "divider"> = [
  ...
  { // For Projects Section...
    ...
    subMenu: [
      {
        icon: "Layers3",
        pathname: "/Project-categories",
        title: "Project Categories",
      },
      {
        icon: "List",
        pathname: "/Project-categories/projects-list",
        title: "Projects List",
      },
      {
        icon: "FolderPlus",
        pathname: "/Project-categories/project-add",
        title: "Projects Add",
      },
      // {
      //   icon: "FolderKanban",
      //   pathname: "/Project-categories/project-escalation",
