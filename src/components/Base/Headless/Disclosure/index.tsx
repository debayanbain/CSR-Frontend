...
function Disclosure({
  children,
  className,
  key = 1, // default key to open & close header
  ...props
  ...
  return (
    <HeadlessDisclosure
      ...
      className={twMerge([
        ...
        group.variant == "boxed" &&
          " first:mt-0 last:mb-5 border border-slate-200/60 mt-3 dark:border-darkmode-400",
        className,
      ])}
      {...props}
    >
...
Disclosure.Button = ({
  ...
  return (
    <HeadlessDisclosure.Button
      as="button"
      className={twMerge([
        "p-3 text-black font-medium w-full text-left dark:text-slate-400",
        disclosure.open && "dark:text-slate-300",
        className,
      ])}
      onClick={() => {
  ...
  return (
    ...
    >
      <HeadlessDisclosure.Panel
        as="div"
        className={twMerge([
          "text-slate-700 leading-relaxed dark:text-slate-400 p-3",
          className,
        ])}
        {...props}
      >
