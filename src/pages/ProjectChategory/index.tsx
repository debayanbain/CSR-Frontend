                ...
                <Table.Tr key={fakerKey} className="intro-x">
                  ...
                  >
                    <div className="flex items-center justify-center">
                      <Tippy content="Edit This Data">
                        <div
                          className="flex items-center mr-3 cursor-pointer hover:text-green-600"
                          onClick={(e) => {
                            e.preventDefault();
      ...
      >
        <Dialog.Panel>
          ...
          <div className="p-5">
            ...
            <FormSelect formSelectSize="md" className="sm:mt-0 sm:mr-0">
