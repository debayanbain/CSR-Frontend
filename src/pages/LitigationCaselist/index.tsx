...
import ViewModal from "@/pages/LitigationCaselist/View/View";
import Accordion from "@/components/AdvanceSearch_Accordion";
import MangeCase from "./ManageCase/manageCase";

function Main() {
  const [viewModalPreview, setViewModalPreview] = useState(false);
  const [manageCaseView, setManageCaseView] = useState(false);
  ...
  const apiData = [
    {
      ...
      Case_Type: "0.43 Acre",
      CNR_No: "Raiyati",
      Case_Status: "Super Admin",
      Filling_Date: "February 2, 2024",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center mt-8 intro-y sm:flex-row">
        <h2 className="mr-auto text-lg font-medium">Litigation Case Lists</h2>
      </div>
