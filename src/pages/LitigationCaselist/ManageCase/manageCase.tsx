...
const MangeCase = ({ isOpens, onCloses }: { isOpens: boolean, onCloses: () => void }) => {
    ...
    return (
        <>
            ...
            >
                <Dialog.Panel>
                    <Dialog.Title>
                        <h2 className="mr-auto text-base font-medium">Case Title New Test |
                            <span className="inline-block text-white mx-[5px] my-0 px-2.5 py-[3px] rounded-[5px] bg-gradient-to-r from-[#0063a8] to-[#74bf44]">CASE-ID-TEST-01 </span>
                            | Of Kohadiya
                        </h2>
                    </Dialog.Title>
                        ...
                        <div className="grid grid-cols-12 gap-2">
                            <div className="intro-y box col-span-12 lg:col-span-12">
                                <div className="row p-1">
                                    <FormLabel htmlFor="regular-form-1">Case ID#</FormLabel>
                                    <FormInput
                                        id="regular-form-1"
                                        type="text"
                                ...
                                <div className="row p-1 cursor-not-allowed">
                                ...
                                <div className="row p-1">
                                    <FormLabel htmlFor="regular-form-1">Case Title</FormLabel>
                                    <FormInput
                                        id="regular-form-1"
                                        type="text"
