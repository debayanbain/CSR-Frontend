...
function Main() {
            ...
            formatter() {
              const buttonsDiv =
                stringToHTML(`<div class="flex lg:justify-center items-center">
                    <button class="view-button bg-yellow-500 py-1 px-4 mx-1 rounded">
                      View
                    </button>
                    <button class="edit-button bg-green-500 py-1 px-4 mx-1 rounded">
                      Edit
                    </button>
                    <button class="history-button bg-red-500 py-1 px-4 mx-1 text-white rounded">
                      History
                    </button>
                    <button class="map-button bg-blue-500 py-1 px-4 mx-1 text-white rounded">Show On Map
                    </button>
                  </div>`);
  ...
  return (
    <>
      <View
        isOpen={viewModalPreview}
        onClose={() => setViewModalPreview(false)}
      />
      <Edit
      ...
      />
      <History
        isOpen={historyModalPreview}
        onClose={() => setHistoryModalPreview(false)}
      />

      <div className="flex flex-col items-center mt-8 intro-y sm:flex-row">
        <h2 className="mr-auto text-lg font-medium">Plot Lists</h2>
      </div>
