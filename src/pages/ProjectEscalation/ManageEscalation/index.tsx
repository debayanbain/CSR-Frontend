...
const ManageEscalation = ({ isOpens, onCloses }: { isOpens: boolean, onCloses: () => void }) => {
                    ...
                    <Dialog.Description className="p-3 grid gap-4 gap-y-3">
                        <div className="grid grid-cols-12 gap-2">
                            <div className="intro-y box col-span-12 lg:col-span-12">
                                ...
                                <div className="row p-1">
                                    <FormLabel htmlFor="regular-form-1">Escalation Title</FormLabel>
                                    <FormInput
                                        id="regular-form-1"
                                        type="text"
                                        placeholder="Enter Case ID"
...
export default ManageEscalation;
